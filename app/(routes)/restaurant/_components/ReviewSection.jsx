...
function ReviewSection({restaurant}) {
  ...
  const handleSubmit = async()=>{
      ...
      GlobalApi.AddNewReview(data).then(resp=>{
        ...
        resp&&GetUserReviewsList();
      })
  }

  const GetUserReviewsList = () =>{
  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 mt-10 gap-10'>
       <div className='flex flex-col gap-2 p-3 rounded-lg shadow-lg border'>
          ...
          <Button disabled={rating==0||!reviewText} onClick={()=>handleSubmit()}>
            Submit
          </Button>
       </div>
