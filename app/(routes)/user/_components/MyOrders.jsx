                ...
                <div className='p-3 border rounded-lg'>
                    ...
                    <Accordion type="single" collapsible>
                        <AccordionItem value="item-1">
                            <AccordionTrigger ><h2 className='text-primary text-sm underline'>View Order Details</h2></AccordionTrigger>
                            <AccordionContent>
                                <div className='flex flex-col gap-3'>
                                    ...
                                    <hr></hr>
                                    <h2 className='font-bold justify-between text-md mt-2'>Total Order Amount (Including Tax):<span>${(order.orderAmount).toFixed(2)}</span></h2>
                                </div>
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
